...
from mdm_services.services.city_service import get_city_service, search_city_service
...
@swagger_auto_schema(
    ...
    request_body=openapi.Schema(
        ...
        properties={"state_id": openapi.Schema(type=openapi.TYPE_NUMBER, description="state id"), },
    ),
...
def get_city(request):
    ...
    try:
        ...
        if request.method == "POST":
            ...
            response_obj = get_city_service(data)
        else:
...
def search_city(request):
    ...
    try:
        ...
        if request.method == "POST":
            ...
            response_obj = search_city_service(search_query)
        else:
            logger.info("Invalid request method: %s", request.method)
            response_obj = {"error_code": errors.invalid_request["error_code"], "message": errors.invalid_request["message"]}
    except Exception as e:
